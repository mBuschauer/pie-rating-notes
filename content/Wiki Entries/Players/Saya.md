...
| --- | --- | --- |
|  [[Rules & Reference/Classes/Rogue/Soulknife#Psychic Blades\|Psychic Blades]] | +7 | 1d6+4 |
|  |  |
>> [!checks| no-t clean]
>> - **Resources:**
...
| | [[Rules & Reference/Classes/Rogue#Thieves' Cant\|Thieves' Cant]] |
| | [[Rules & Reference/Classes/Rogue#Cunning Action\|Cunning Action]] |
...
> **Tools**: Thieves' tools, Vehicles (land & water)
> **Languages**: Common, Theives' Cant

# Saya
- They have sun-kissed skin, long hair with small shells/seaglass woven into braids (keepsakes from home).
- Their usual outfit is a simple tunic and trousers (they want to blend into port towns, and they only have a small knife for show, since their real weapons are psychic).
